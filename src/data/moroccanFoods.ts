...
export const MOROCCAN_FOODS: MoroccanFood[] = [
  ...
  /* These two shared an id with the entries above until 2026-07-25. A
     duplicate id is not cosmetic here: React omitted one of the pair, and
     the detail panel keyed on the id opened BOTH at once — so a patient
     could log the 300 g portion while reading the 350 g numbers, and those
     carbohydrates go on to size an insulin dose. They are genuinely
     different dishes, so both are kept, under their own ids. */
  { id: 'seffa_sucree', name_en: 'Seffa (sweet couscous)', name_fr: 'Seffa sucrée', name_ar: 'السفة', category: 'main', serving_size: '1 assiette (300 g)', serving_grams: 300, calories: 540, carbs: 80, sugar: 30, protein: 14, fat: 18, fiber: 4, sodium: 220, glycemic_index: 60, emoji: '🍚', aliases: ['seffa', 'medfouna', 'سفة'] },
  { id: 'loubia_zit', name_en: 'Loubia (white bean stew)', name_fr: 'Loubia à l’huile', name_ar: 'اللوبيا', category: 'main', serving_size: '1 assiette (350 g)', serving_grams: 350, calories: 320, carbs: 44, sugar: 6, protein: 18, fat: 8, fiber: 12, sodium: 720, glycemic_index: 35, emoji: '🫘', aliases: ['loubia bzit', 'لوبية'] },
